...
export async function postProduto(req, reply) {
    const { id, nome, unidade, estoqueatual, semana1, semana2, semana3, semana4, estoquezerandoem, alerta } = bodySchema.parse(req.body);
...
//# sourceMappingURL=postProdutos.js.map